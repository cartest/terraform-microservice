...
resource "aws_launch_configuration" "launch_configuration" {
  name_prefix          = "${var.tags["Environment"]}-${var.tags["Application"]}-${var.tags["Tier"]}-${var.name}-${var.app-stack-color}-LC/"
...
resource "aws_autoscaling_group" "autoscaling_group" {
  name                 = "${var.tags["Environment"]}-${var.tags["Application"]}-${var.tags["Tier"]}-${var.name}-${var.app-stack-color}-ASG"
